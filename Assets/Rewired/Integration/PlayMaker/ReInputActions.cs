...
#if !UNITY_2021_PLUS
#define REWIRED_SUPPORTS_XBOX_ONE_XDK
#endif

#if UNITY_2018_PLUS
#define REWIRED_SUPPORTS_GAMECONTROLLERFRAMEWORK
#endif

#if UNITY_2021_2_PLUS
#define REWIRED_MAY_SUPPORT_XR_CONTROLLERS
#endif

#if UNITY_2017_PLUS
#define REWIRED_SUPPORTS_PS4
#if !UNITY_2018
#define REWIRED_SUPPORTS_PS5
#endif
#endif
...
#if REWIRED_SUPPORTS_GAMECONTROLLERFRAMEWORK

    [ActionCategory("Rewired")]
    [Tooltip("Gets whether Apple Game Controller Framework will be used for compatible devices. Only applies to platforms that support Game Controller Framework. Rewired will be completely reset if this value is changed.")]
    public class RewiredConfigGetUseAppleGameControllerFramework : GetBoolFsmStateAction
    {
        protected override bool defaultValue_everyFrame { get { return false; } }

        protected override void DoUpdate()
        {
            UpdateStoreValue(ReInput.configuration.useAppleGameControllerFramework);
        }
    }

    [ActionCategory("Rewired")]
    [Tooltip("Sets whether Apple Game Controller Framework will be used for compatible devices. Only applies to platforms that support Game Controller Framework. Rewired will be completely reset if this value is changed.")]
    public class RewiredConfigSetUseAppleGameControllerFramework : SetBoolFsmStateAction
    {
        protected override bool defaultValue_everyFrame { get { return false; } }

        protected override void DoUpdate()
        {
            ReInput.configuration.useAppleGameControllerFramework = value.Value;
        }
    }

#endif

#if REWIRED_SUPPORTS_XBOX_ONE_XDK

    [ActionCategory("Rewired")]
    [Tooltip("Changes the primary input source in Xbox One (XDK) during runtime. Rewired will be completely reset if this value is changed.")]
...
#if REWIRED_SUPPORTS_PS5

    [ActionCategory("Rewired")]
    [Tooltip("Changes the primary input source in PS5 during runtime. Rewired will be completely reset if this value is changed.")]
    public class RewiredConfigGetPS5PrimaryInputSource : GetEnumFsmStateAction
    {
        [UIHint(UIHint.Variable), ObjectType(typeof(PS5PrimaryInputSource))]
        [Tooltip("Store the result in an enum variable.")]
        public FsmEnum storeValue;
        protected override FsmEnum _storeValue { get { return storeValue; } set { storeValue = value; } }
        ...
        protected override void DoUpdate()
        {
            UpdateStoreValue(ReInput.configuration.ps5PrimaryInputSource);
        }
    }

    [ActionCategory("Rewired")]
    [Tooltip("Changes the primary input source in PS5 during runtime. Rewired will be completely reset if this value is changed.")]
    public class RewiredConfigSetPS5PrimaryInputSource : SetEnumFsmStateAction
    {
        [RequiredField]
        [Tooltip("The value to set."), ObjectType(typeof(PS5PrimaryInputSource))]
        public FsmEnum value;
        protected override FsmEnum _value { get { return value; } set { this.value = value; } }
        ...
        protected override void DoUpdate()
        {
            ReInput.configuration.ps5PrimaryInputSource = (PS5PrimaryInputSource)value.Value;
        }
    }
...
[ActionCategory("Rewired")]
    [Tooltip("Changes the primary input source in Android during runtime. Rewired will be completely reset if this value is changed.")]
    public class RewiredConfigGetAndroidPrimaryInputSource : GetEnumFsmStateAction
    {
        [UIHint(UIHint.Variable), ObjectType(typeof(AndroidPrimaryInputSource))]
        [Tooltip("Store the result in an enum variable.")]
        public FsmEnum storeValue;
        protected override FsmEnum _storeValue { get { return storeValue; } set { storeValue = value; } }
        ...
        protected override void DoUpdate()
        {
            UpdateStoreValue(ReInput.configuration.androidPrimaryInputSource);
        }
    }

    [ActionCategory("Rewired")]
    [Tooltip("Changes the primary input source in Android during runtime. Rewired will be completely reset if this value is changed.")]
    public class RewiredConfigSetAndroidPrimaryInputSource : SetEnumFsmStateAction
    {
        [RequiredField]
        [Tooltip("The value to set."), ObjectType(typeof(AndroidPrimaryInputSource))]
        public FsmEnum value;
        protected override FsmEnum _value { get { return value; } set { this.value = value; } }
        ...
        protected override void DoUpdate()
        {
            ReInput.configuration.androidPrimaryInputSource = (AndroidPrimaryInputSource)value.Value;
        }
    }

[ActionCategory("Rewired")]
    [Tooltip("Changes the primary input source in iOS during runtime. Rewired will be completely reset if this value is changed.")]
    public class RewiredConfigGetIOSPrimaryInputSource : GetEnumFsmStateAction
    {
        [UIHint(UIHint.Variable), ObjectType(typeof(IOSPrimaryInputSource))]
        [Tooltip("Store the result in an enum variable.")]
        public FsmEnum storeValue;
        protected override FsmEnum _storeValue { get { return storeValue; } set { storeValue = value; } }
        ...
        protected override void DoUpdate()
        {
            UpdateStoreValue(ReInput.configuration.iOSPrimaryInputSource);
        }
    }

    [ActionCategory("Rewired")]
    [Tooltip("Changes the primary input source in iOS during runtime. Rewired will be completely reset if this value is changed.")]
    public class RewiredConfigSetIOSPrimaryInputSource : SetEnumFsmStateAction
    {
        [RequiredField]
        [Tooltip("The value to set."), ObjectType(typeof(IOSPrimaryInputSource))]
        public FsmEnum value;
        protected override FsmEnum _value { get { return value; } set { this.value = value; } }
        ...
        protected override void DoUpdate()
        {
            ReInput.configuration.iOSPrimaryInputSource = (IOSPrimaryInputSource)value.Value;
        }
    }

    [ActionCategory("Rewired")]
    [Tooltip("Changes the primary input source in tvOS during runtime. Rewired will be completely reset if this value is changed.")]
    public class RewiredConfigGetTVOSPrimaryInputSource : GetEnumFsmStateAction
    {
        [UIHint(UIHint.Variable), ObjectType(typeof(TVOSPrimaryInputSource))]
        [Tooltip("Store the result in an enum variable.")]
        public FsmEnum storeValue;
        protected override FsmEnum _storeValue { get { return storeValue; } set { storeValue = value; } }
        ...
        protected override void DoUpdate()
        {
            UpdateStoreValue(ReInput.configuration.tvOSPrimaryInputSource);
        }
    }

    [ActionCategory("Rewired")]
    [Tooltip("Changes the primary input source in tvOS during runtime. Rewired will be completely reset if this value is changed.")]
    public class RewiredConfigSetTVOSPrimaryInputSource : SetEnumFsmStateAction
    {
        [RequiredField]
        [Tooltip("The value to set."), ObjectType(typeof(TVOSPrimaryInputSource))]
        public FsmEnum value;
        protected override FsmEnum _value { get { return value; } set { this.value = value; } }
        ...
        protected override void DoUpdate()
        {
            ReInput.configuration.tvOSPrimaryInputSource = (TVOSPrimaryInputSource)value.Value;
        }
    }
    ...
    [ActionCategory("Rewired")]
    [Tooltip("Toggles Show System Key Labels during runtime.")]
    public class RewiredConfigGetShowSystemKeyLabels : GetBoolFsmStateAction
    {
        protected override bool defaultValue_everyFrame { get { return false; } }

        protected override void DoUpdate()
        {
            UpdateStoreValue(ReInput.configuration.showSystemKeyLabels);
        }
    }

    [ActionCategory("Rewired")]
    [Tooltip("Toggles Show System Key Labels during runtime.")]
    public class RewiredConfigSetShowSystemKeyLabels : SetBoolFsmStateAction
    {
        protected override bool defaultValue_everyFrame { get { return false; } }

        protected override void DoUpdate()
        {
            ReInput.configuration.showSystemKeyLabels = value.Value;
        }
    }
...
#if REWIRED_MAY_SUPPORT_XR_CONTROLLERS

    [ActionCategory("Rewired")]
    [Tooltip("Toggles the support of XR controllers during runtime. Rewired will be completely reset if this value is changed.")]
    public class RewiredConfigGetSupportXRControllers : GetBoolFsmStateAction {
        protected override bool defaultValue_everyFrame { get { return false; } }

        protected override void DoUpdate() {
            UpdateStoreValue(ReInput.configuration.supportXRControllers);
        }
    }

    [ActionCategory("Rewired")]
    [Tooltip("Toggles the support of XR controllers during runtime. Rewired will be completely reset if this value is changed.")]
    public class RewiredConfigSetSupportXRControllers : SetBoolFsmStateAction {
        protected override bool defaultValue_everyFrame { get { return false; } }

        protected override void DoUpdate() {
            ReInput.configuration.supportXRControllers = value.Value;
        }
    }
