...
namespace Rewired.Integration.PlayMaker {
    ...
    [ActionCategory("Rewired")]
    [Tooltip("Gets the keyboard key code. Only used for keyboard bindings.")]
    ...
    [ActionCategory("Rewired")]
    [Tooltip("Sets the keyboard key code. Only used for keyboard bindings.")]
    ...
    public class RewiredActionElementMapSetKeyCode : RewiredActionElementMapFsmStateAction {
        ...
        protected override void DoUpdate() {
            aem.keyCode = (KeyboardKeyCode)value.Value;
        }
    }
